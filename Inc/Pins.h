...
extern void PinAll_Init(void); //must be call before any setting; turn off all circuit outside microcontroller

extern void PinCntrlPer_On(void);  // for turn on any circuit outside microcontroller; must be call before any command to outside circuit 
extern void PinCntrlPer_Off(void);	// for turn off any circuit outside microcontroller; before this must be call _Off function for active outside circuit
